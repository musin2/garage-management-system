    ...
    return(
        ...
        <div className="container-sm m-4">
            ...
            <div className="row m-1">
                <div className="col-2">
                <label htmlFor="make" className="col-form-label">Car Make</label>
                </div>
                <div className="col-3">
            ...
            <div className="row m-1">
                ...
                <div className="col-2">
                <label htmlFor="vehicle_plate" className="col-form-label">License Plate</label>
                </div>
                <div className="col-3">
                <input type="text" name="vehicle_plate" id="vehicle_plate" className="form-control" 
                onChange={(e)=>{setPlate(e.target.value)}} required/>
                </div>
            </div>
            <div className=" text-center ">
                <button type="submit" className="btn btn-info m-2">Add Vehicle</button>
            </div>
            </form>
        </div>
        </>
